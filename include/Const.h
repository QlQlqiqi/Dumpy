...
public:
  // sec:expr
  static string rootfn, resfn;
  static string dataset;
  static int simulate_type,index, MAX_TOPK, ops, query_num, series_num, k, visited_node_num,
      dtw_window_size, nprobes;
  ...
  static int th, bitsCardinality, delta, r_max, fbl_size, max_diff,
      fbl_series_num, pre_read;
  static double fuzzy_f_1st, fuzzy_f, alpha_1st, alpha, small_perc,
      max_mask_bit_percentage, f_low, f_high;
  ...
  static void readConfig() {
    ...
    simulate_type = reader.GetInteger("expr", "simulate_type", -1);
    ...
    max_mask_bit_percentage =
        reader.GetReal("parameter", "max_mask_bit_percentage", 0.5);
